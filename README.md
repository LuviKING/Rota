...
- Movimento: sessões pendentes podem ser arrastadas para outra data, com validação de prazo, dias disponíveis, carga diária e revisões protegidas
...
- Histórico de progresso: visão dos últimos 12 meses e comparação das últimas 8 semanas com a semana anterior
