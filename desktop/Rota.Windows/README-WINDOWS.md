...
- sessões pendentes mostram uma indicação de arraste e podem ser movidas para outro dia no calendário; uma prévia pede confirmação, o último movimento pode ser desfeito e prazo, dias disponíveis e limite diário são validados, enquanto concluídas e revisões automáticas permanecem imóveis;
